...
class Topic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<MapEntry<String, dynamic>> topicList = topic.data["Topic"].entries
        .toList(); //converting to entries so that cover and topic can be sorted
